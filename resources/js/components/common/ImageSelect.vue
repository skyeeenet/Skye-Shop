    ...
    <form @submit.prevent="onSubmitHandler" class="image-select-container">
        <div class="image-select-header-container">
            ...
            <div class="image-select-header-item mt-10">
                ...
                <button
                        @click="deleteItems"
                        type="button" class="btn btn-danger">Remove <span class="btn-icon-right"><i class="fa fa-close"></i></span></button>
            </div>
        </div>
        ...
        <div class="image-select-footer-container">
            ...
            ></Pagination>
            <div>
                <button @click="onCloseHandler" v-if="!showPreloader" type="button" class="btn mr-2 btn-ft btn-flat btn-dark">Close</button>
                <button :disabled="disableSubmit" v-if="!showPreloader" type="submit" class="btn btn-ft btn-flat btn-success">Select</button>
