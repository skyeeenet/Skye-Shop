  ...
  <div class="nk-sidebar">
    <div class="nk-nav-scroll">
      <ul class="metismenu" id="menu">
        ...
        <li @click="click_link($event)" class="mega-menu mega-menu-lg">
          <a class="has-arrow" href="#" aria-expanded="false">
            <i class="mdi mdi-view-dashboard"></i><span class="nav-text">Catalog</span><span
                  class="badge bg-dpink text-white nav-badge">4</span>
          </a>
          <ul aria-expanded="false">

            <li>
              <router-link tag="a" :to="{ name: 'category' }">Category</router-link>
            </li>

            <li>
              <router-link tag="a" :to="{ name: 'attribute' }">Attribute</router-link>
            </li>

            <li>
              <router-link tag="a" :to="{ name: 'option-group' }">Option Groups</router-link>
            </li>

            <li>
              <router-link tag="a" :to="{ name: 'option-value-index' }">Options</router-link>
            </li>
        ...
        <li class="mega-menu mega-menu-lg">
          <a class="has-arrow" href="#" aria-expanded="false">
            <i class="mdi mdi-view-dashboard"></i><span class="nav-text">Sales</span><span
        ...
        <li class="mega-menu mega-menu-sm"><a class="has-arrow" href="#" aria-expanded="false">
          <i class="mdi mdi-page-layout-body"></i><span class="nav-text">Customers</span><span
        ...
        <li class="mega-menu mega-menu-lg">
          <a class="has-arrow" href="#" aria-expanded="false">
            <i class="mdi mdi-view-dashboard"></i><span class="nav-text">Blog</span><span
                  class="badge bg-dpink text-white nav-badge">21</span>
          </a>
          <ul aria-expanded="false">
        ...
        <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-email-outline"></i> <span
                class="nav-text">Email</span><span class="badge bg-lgreen text-white nav-badge">০3</span></a>
          <ul aria-expanded="false">
        ...
        <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-application"></i><span
                class="nav-text">Apps</span> <span class="badge badge-info nav-badge">05</span></a>
          <ul aria-expanded="false">
        ...
        <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-ticket"></i><span class="nav-text">Ticket</span>
          <span class="badge bg-lgreen text-white nav-badge">02</span></a>
          <ul aria-expanded="false">
        ...
        <li class="mega-menu mega-menu-lg"><a class="has-arrow" href="#" aria-expanded="false"><i
        ...
        <li class="mega-menu mega-menu-md"><a class="has-arrow" href="#" aria-expanded="false"><i
        ...
        <li class="mega-menu mega-menu-xl"><a class="has-arrow" href="#" aria-expanded="false"><i
        ...
        <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="nav-text">Widget</span>
          <span class="badge bg-dpink text-white nav-badge">03</span></a>
          <ul aria-expanded="false">
        ...
        <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-table"></i><span class="nav-text">Table</span>
          <span class="badge badge-primary nav-badge">13</span></a>
          <ul aria-expanded="false">
        ...
        <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-message-draw"></i><span
                class="nav-text">Invoice</span><span class="badge badge-success nav-badge">03</span></a>
          <ul aria-expanded="false">
        ...
        <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-book-open-page-variant"></i><span
                class="nav-text">Pages</span> <span class="badge badge-info nav-badge">28</span></a>
          <ul aria-expanded="false">
  ...
  export default {
    ...
    methods: {
      ...
      click_link(e) {
        ...
        e.target.className = e.target.className =="active1"?"":"active1";
      },
    },
  }
</script>
