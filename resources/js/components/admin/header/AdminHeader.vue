                ...
                <ul>
                    ...
                    <li class="icons">
                        <a href="javascript:void(0)" class="log-user">
                            <img src="/assets/images/avatar/1.jpg" alt=""> <span></span>  <i class="fa fa-caret-down f-s-14" aria-hidden="true"></i>
                        </a>
                        <div class="drop-down dropdown-profile animated bounceInDown">
                            <div class="dropdown-content-body">
                                <ul>
                                    <li><a href="javascript:void()"><i class="icon-user"></i> <span></span></a>
                                    </li>
                                    ...
                                    <li><a href="/locale/en"><i class="icon-power"></i> <span>English</span></a>
                                    </li>
                                    <li><a href="/locale/ru"><i class="icon-power"></i> <span>Russian</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
