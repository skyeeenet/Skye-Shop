        ...
        <ul class="metismenu" id="menu">
            <li class="mega-menu mega-menu-lg">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="index-hospital.html">{{ Lang::get('dashboard.options') }}</a>
                    </li>
                    <li><a href="index-real-estate.html">{{ Lang::get('dashboard.manufacturers') }}</a>
                    </li>
                </ul>
            </li>
            <li class="mega-menu mega-menu-lg">
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    <i class="mdi mdi-view-dashboard"></i><span class="nav-text">{{ Lang::get('dashboard.sales') }}</span><span class="badge bg-dpink text-white nav-badge">21</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="index-restaurent.html">{{ Lang::get('dashboard.orders') }}</a></li>
                    <li><a href="index-crypto.html">{{ Lang::get('dashboard.recurring') }}</a>
                    </li>
                </ul>
            </li>
            <li class="mega-menu mega-menu-sm"><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    <i class="mdi mdi-page-layout-body"></i><span class="nav-text">{{ Lang::get('dashboard.customers') }}</span><span class="badge badge-success nav-badge">11</span></a>
                <ul aria-expanded="false">
                    <li><a href="./layout-blank.html">{{ Lang::get('dashboard.users') }}</a>
                    </li>
                    <li><a href="./layout-boxed.html">{{ Lang::get('dashboard.reviews') }}</a>
                    </li>
                </ul>
            </li>
            <li class="mega-menu mega-menu-lg">
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    <i class="mdi mdi-view-dashboard"></i><span class="nav-text">{{ Lang::get('dashboard.blog') }}</span><span class="badge bg-dpink text-white nav-badge">21</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="index-restaurent.html">{{ Lang::get('dashboard.pages') }}</a></li>
                    <li><a href="index-crypto.html">{{ Lang::get('dashboard.products') }}</a>
                    </li>
                    <li><a href="index-invoice.html">{{ Lang::get('dashboard.attributes') }}</a>
                    </li>
