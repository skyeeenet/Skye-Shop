        ...
        <div class="nk-nav-scroll">
            <ul class="metismenu" id="menu">
                <li class="mega-menu mega-menu-lg">
                    ...
                    <router-link tag="a" :to="{ name: 'dashboard' }" aria-expanded="false">
                ...
                <li class="mega-menu mega-menu-lg">
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        <i class="mdi mdi-view-dashboard"></i><span class="nav-text">Catalog</span><span class="badge bg-dpink text-white nav-badge">21</span>
                    </a>
                    <ul aria-expanded="false">

                        <li><router-link tag="a" :to="{ name: 'category' }">Category</router-link></li>
                ...
                <li class="mega-menu mega-menu-lg">
                    <a class="has-arrow" href="#" aria-expanded="false">
                        <i class="mdi mdi-view-dashboard"></i><span class="nav-text">Sales</span><span class="badge bg-dpink text-white nav-badge">21</span>
                    </a>
                    <ul aria-expanded="false">
                        <li><a href="index-restaurent.html">Orders</a></li>
                        <li><a href="index-crypto.html">Recurring</a>
                        </li>
                    </ul>
                </li>
                <li class="mega-menu mega-menu-sm"><a class="has-arrow" href="#" aria-expanded="false">
                    <i class="mdi mdi-page-layout-body"></i><span class="nav-text">Customers</span><span class="badge badge-success nav-badge">11</span></a>
                    <ul aria-expanded="false">
                        <li><a href="./layout-blank.html">Users</a>
                        </li>
                        <li><a href="./layout-boxed.html">Reviews</a>
                        </li>
                    </ul>
                </li>
                <li class="mega-menu mega-menu-lg">
                    <a class="has-arrow" href="#" aria-expanded="false">
                        <i class="mdi mdi-view-dashboard"></i><span class="nav-text">Blog</span><span class="badge bg-dpink text-white nav-badge">21</span>
                    </a>
                    <ul aria-expanded="false">
                        <li><a href="index-restaurent.html">Blog</a></li>
                        <li><a href="index-crypto.html">Products</a>
                        </li>
                        <li><a href="index-invoice.html">Attributes</a>
                        </li>
                        <li><a href="index-hospital.html">Options</a>
                        </li>
                        <li><a href="index-real-estate.html">Manufacturers</a>
                        </li>
                    </ul>
                ...
                <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-email-outline"></i> <span class="nav-text">Email</span><span class="badge bg-lgreen text-white nav-badge">০3</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-application"></i><span class="nav-text">Apps</span> <span class="badge badge-info nav-badge">05</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-ticket"></i><span class="nav-text">Ticket</span> <span class="badge bg-lgreen text-white nav-badge">02</span></a>
                    <ul aria-expanded="false">
                ...
                <li class="mega-menu mega-menu-lg"><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-chart-bar"></i> <span class="nav-text">Charts</span> <span class="badge badge-primary nav-badge">19</span></a>
                    <ul aria-expanded="false">
                ...
                <li class="mega-menu mega-menu-md"><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-television-guide"></i><span class="nav-text">UI </span> <span class="badge badge-danger nav-badge">19</span></a>
                    <ul aria-expanded="false">
                ...
                <li class="mega-menu mega-menu-xl"><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-collage"></i><span class="nav-text">Components</span> <span class="badge bg-lgreen text-white nav-badge">39</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="nav-text">Widget</span> <span class="badge bg-dpink text-white nav-badge">03</span></a>
                    <ul aria-expanded="false">
                ...
                <li class="mega-menu mega-menu-lg"><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gradient"></i><span class="nav-text">Forms</span> <span class="badge badge-info nav-badge">28</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-table"></i><span class="nav-text">Table</span> <span class="badge badge-primary nav-badge">13</span></a>
                    <ul aria-expanded="false">
                        <li><a class="has-arrow" href="#" aria-expanded="false">Bootstrap Table</a>
                            <ul aria-expanded="false">
                        ...
                        <li><a class="has-arrow" href="#" aria-expanded="false">Data Table</a>
                            <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-message-draw"></i><span class="nav-text">Invoice</span><span class="badge badge-success nav-badge">03</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-book-open-page-variant"></i><span class="nav-text">Pages</span> <span class="badge badge-info nav-badge">28</span></a>
                    <ul aria-expanded="false">
                        <li><a href="page-pricing.html">Pricing</a>
                        </li>
                        <!-- <li><a href="page-gallery.html">Gallery</a>
                        </li> -->
                        <li><a class="has-arrow" href="#" aria-expanded="false">Timeline</a>
                            <ul aria-expanded="false">
                        ...
                        <li><a class="has-arrow" href="#" aria-expanded="false">Login</a>
                            <ul aria-expanded="false">
                        ...
                        <li><a class="has-arrow" href="#" aria-expanded="false">Register</a>
                            <ul aria-expanded="false">
                        ...
                        <li><a class="has-arrow" href="#" aria-expanded="false">Crypto</a>
                            <ul aria-expanded="false">
                        ...
                        <li><a class="has-arrow" href="#" aria-expanded="false">Contact</a>
                            <ul aria-expanded="false">
